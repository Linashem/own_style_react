      ...
      >
        ...
        >
          ...
          <p>
            ...
            линейность лица, карту длин изделий. Далее, я выдаю ряд рекомендаций
            по подбору фасонов, тканей, фактур, и даже причесок.
          </p>
          <p>
            И, когда мы, непосредственно переходим ко второму блоку обучения -
            конструированию и пошиву изделий, вы уже сможете выбрать в магазине
            подходящую ткань, определиться с фасоном и длиной изделия.
          </p>
          <p>
            Королевы мои, в нашей школе мы создаем осознанный, функциональный,
            по всем параметрам подходящий, именно для вас, ГАРДЕРОБ МЕЧТЫ, а не
            шьем одежду ради одежды!
          </p>
